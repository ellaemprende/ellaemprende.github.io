			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - Ella Emprende</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - Ella Emprende</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>Archivo KML</h1>
															...
															<p>
									Este archivo KML ha sido generado por el <a href="https://rankmath.com/" target="_blank">plugin Rank Math WordPress SEO</a>. Se usa para proporcionar a Google información de la ubicación.								</p>
